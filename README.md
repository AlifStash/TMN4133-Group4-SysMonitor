...
# 2. run sysmonitor.c by typing "./sysmonitor" in the terminal
# 3. Select Option 1 - 5 to use the feature that are available in sysmonitor
# 4. Ctrl + C to exit and save logs in any mode.
